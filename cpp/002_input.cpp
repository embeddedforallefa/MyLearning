...
// >> is used with std::cin, and shows the direction that data is moving (if
// std::cin represents the keyboard, the input data is moving from the keyboard
// to the variable). std::cin >> x moves the value the user entered from the
// keyboard into x
